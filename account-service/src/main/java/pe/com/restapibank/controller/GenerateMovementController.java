...
public class GenerateMovementController {
	...
	// // Plazo fijo: libre de comisión por mantenimiento, solo permite un
	// movimiento de retiro o depósito en un día específico del mes.
	// @PostMapping
	// public ResponseEntity<Mono<Movement>> createMovAccountFixed (@RequestBody
	// Movement Movement){
